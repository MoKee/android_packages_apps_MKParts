...
public class FingerprintShortcutSettings extends SettingsPreferenceFragment {
    ...
    private void addFingerprintItemPreferences(PreferenceGroup root) {
        ...
        final SparseArray<String> shortcuts = mFpShortcutManager.getShortcuts();
        ...
        for (Fingerprint item : mFingerprintManager.getEnrolledFingerprints(mUserId)) {
            ...
            pref.setSummary(target == null
                    ? notSpecified
                    : mFpShortcutManager.getLabel(target, R.string.fingerprint_shortcut_label));
