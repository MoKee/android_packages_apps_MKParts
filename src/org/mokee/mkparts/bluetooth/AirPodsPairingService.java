...
public class AirPodsPairingService extends Service {
    ...
    private void handleDeviceFound() {
        ...
        switch (mDeviceFound.getBondState()) {
            ...
            case BluetoothDevice.BOND_BONDED:
                mNotificationManager.notify(mDeviceFound.getAddress().hashCode(), createNotification()
                        .setContentTitle(getString(R.string.bluetooth_bonded_title, mDeviceFound.getName()))
                        .setContentText(getString(R.string.bluetooth_bonded_manage))
                        .build());
                break;
        }
    }
